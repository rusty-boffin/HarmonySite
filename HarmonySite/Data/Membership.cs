...
namespace RustyBoffin.HarmonySite.Data
{
    ...
    public class Membership : HSObject
    {
        ...
        public ListItem SponLevel => GetValue(() => SponLevel);   //	Sponsorship level	single option from database (dropdowns)	one of these values | Administer
        ...
        public bool GiftAid => GetValue(() => GiftAid);  //	Allocate a percentage of fees to Gift Aid?	boolean (yes/no)	Yes or No
        public string XeroID => GetValue(() => XeroID); //	Xero Client ID	text	any value
