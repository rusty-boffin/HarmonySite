...
namespace RustyBoffin.HarmonySite.Data
{
    ...
    public class FeeSchedule : HSObject
    {
        ...
        public string DuesType => GetValue(() => DuesType); //	Fees payable	single option from database (dropdowns)	one of these values | Administer
        ...
        public string Amount => GetValue(() => Amount);    //	Amount	integer	any currency value (in cents/pence/etc)
